...
import (
	...
	"github.com/sospartan/pocketbase/tools/logger"
	"github.com/sospartan/pocketbase/tools/mailer"
	"github.com/sospartan/pocketbase/tools/routine"
	"github.com/sospartan/pocketbase/tools/store"
	"github.com/sospartan/pocketbase/tools/subscriptions"
...
func (app *BaseApp) initAuxDB() error {
	...
	// (see https://github.com/sospartan/pocketbase/issues/5607)
	...
	app.OnModelAfterDeleteSuccess().Bind(&hook.Handler[*ModelEvent]{
		...
		Func: func(e *ModelEvent) error {
			if m, ok := e.Model.(FilesManager); ok && m.BaseFilesPath() != "" && supportFiles(e.Model) {
				...
				// (https://github.com/sospartan/pocketbase/discussions/5246#discussioncomment-10128955)
